...
import { Paper, TextField, Button, Typography, Box, Stack, Divider, Alert } from "@mui/material";
      ...
      <Stack spacing={3}>
        ...
        <Box sx={{ display: "flex", justifyContent: "flex-end", gap: 4 }}>
          ...
          <Box sx={{ borderLeft: "2px solid", borderColor: "divider", pl: 4 }}>
            ...
            <Typography variant="h6" sx={{ fontWeight: 700, color: "primary.main", fontSize: "1.3rem" }}>
